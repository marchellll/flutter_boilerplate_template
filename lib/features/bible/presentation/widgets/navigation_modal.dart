      ...
      builder: (context, child) {
        ...
        return AnimatedContainer(
          ...
          child: DraggableScrollableSheet(
            initialChildSize: isGridTab ? 1.0 : 0.7,
            minChildSize: isGridTab ? 1.0 : 0.6,
            maxChildSize: isGridTab ? 1.0 : 0.8,
...
class _DialerNavigationTab extends StatefulWidget {
  @override
  _DialerNavigationTabState createState() => _DialerNavigationTabState();
}

class _DialerNavigationTabState extends State<_DialerNavigationTab> {
                  ...
                  Expanded(
                    ...
                    child: Column(
                      children: [
                        ...
                        // Numpad
                        SizedBox(
                          height: 200, // Fixed height for numpad
